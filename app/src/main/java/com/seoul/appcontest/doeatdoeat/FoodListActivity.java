...
public class FoodListActivity extends Activity {
    ...
    //@InjectView(R.id.list_menutitle) TextView _menuTitle;
    //@InjectView(R.id.list_menutext) TextView _menuText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(menuNum==R.id.menu_rice){
            ...
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.bibimbap),"숭늉","밥솥 바닥에 열이 많이 가해져 눌러 붙은 밥(‘누룽지’라고 한다.)에 물을 붓고 끓여 만든 음식");//사진
            ...
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.zzazangmyun),"짬뽕","여러가지 채소와 해산물을 볶아 육수를 부어 만든 국물에 면을 넣어 먹는 음식");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.lamyun),"라면","기름에 미리 튀긴 국수를 스프와 함께 끓는 물에 넣어서 요리하는 레토르트 식품");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.lamyun),"뜨거운 볶음면","기름에 미리 튀긴 국수를 끓는 물에 익힌 후 소스에 비벼먹는 레토르트 음식");
            ...
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.samgyupsal),"탕수육","튀긴 돼지고기에 탕수 소스를 곁들여 먹는 음식");
            ...
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gozingamrae),"고진감래","한국의 술인 소주와 맥주, 콜라를 정해진 순서에 따라 제조한 술로 쓴맛과 단맛이 절묘하게 잘 어울리는 술");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.meronazu),"메로나주","소주와 사이다와 메로나 아이스크림을 섞어 달콤하면서도 톡쏘는 맛을 내는 술");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.makgulli),"막걸리","찹쌀•보리•밀가루 등을 전통적인 방식으로 발효시켜 제조한 한국의 전통 술");
            ...
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"컵라면","편의점에서 판매되는 일회용 용기에 담겨있는 라면");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"컵볶음면","편의점에서 판매되는 일회용 용기에 담겨있는 볶음라면");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"오감자 치즈후라이","한국의 감자칩에 치즈를 뿌려 만든 음식");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"삼각김밥","삼각형 모양의 주먹밥 속에 참지, 불고기 등 한가지 재료를 넣고 김으로 감싼 레토르트 식품");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"마크정식","인스턴트 떡볶이에 스파게티, 후랑크소세지를 넣고 모짜렐라 치즈를 얹어 먹는 음식");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"치즈 불닭볶음밥","매운 떡볶이에 밥과 스트링 치즈를 함께 넣어먹는 음식");
            adapter.addItem(ContextCompat.getDrawable(this,R.drawable.gimbap),"아포카토","아이스크림에 진한 에스프레소를 얹은 디저트");
        }else{
